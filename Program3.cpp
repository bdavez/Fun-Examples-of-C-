...
/*
 DOCUMENTATION
    Accreditation:
        I found a useful resource for setting precision of cout this was found at: https://stackoverflow.com/questions/5907031/printing-the-correct-number-of-decimal-places-with-cout
        the code I ended up implementing was:
        cout << fixed;
        cout << setprecision();
    Program Purpose:
    ...
    Variables:
        cel - Stores the updated value (double) of Celsius
        fah - Stores the updated value (double) of Fahrenheit
*/
...
450.000         232.222  |      450.000         842.000
 ...
 Discussion:
    This program uses no standard input
...
int main () 
{
    ...
    cout << "  F \t \t  C      | \t  C \t  \t  F" << endl;
    while (fah != 455) {
        cout << fah << "\t \t" << fToC(fah) << "\t | \t" << cel << "\t \t" << cToF(cel)<< endl; 
        fah += 5;
        cel += 5; 
    }
